...
export default function Billing({ billing = {} }) {
  ...
  return (
    <AgencyLayout title="Cobrança e Assinatura">
      <Head title="Cobrança e Assinatura" />
      <div className="mb-8">
        <h2 className="text-2xl font-semibold">Cobrança e Assinatura</h2>
        <p className="text-muted-foreground">Gerencie o plano da agência, pagamentos e histórico de cobranças</p>
      </div>
      <div className="space-y-8">
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
          ...
          <Button onClick={handleCheckout} disabled={loading} className="mt-2">Pagar com Stripe</Button>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
          ...
          <ul className="divide-y divide-gray-200 dark:divide-gray-700">
            {(billing.charges || [{id: 1, date: '2024-06-01', amount: 'R$ 299,00', status: 'Pago'}]).map(charge => (
